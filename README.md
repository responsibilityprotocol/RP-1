...
|------|--------|-------------|
| `RP-1_CONSTITUTION.md` | RP-1 Constitution | Core ethical commitments, protected principles, and structural non-harm mandates. |
...
## Ethical Integrity Infrastructure
| File | Description |
|------|-------------|
| `EII_SPECIFICATION.md` | Defines harm assessment, intervention scaling, distributed review, and anti-corruption safeguards. |
...
| File | Description |
|------|-------------|
| `RP-1_INDEX.md` | Canonical reference map linking all documents. |
| `CHANGELOG.md` | Traceable version history of updates. |